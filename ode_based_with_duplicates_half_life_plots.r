# This is akin to ode_based_half_life_plots.r, but using the
...
pdf("ode_based_with_duplicates_known_vl_half_lives.pdf")
plot.all.individuals.half.lives(mles[mles$vl.info == "known",])
dev.off()

pdf("ode_based_with_duplicates_known_vl_half_lives_two_sampling_points.pdf")
plot.multiple.timepoints.half.lives(mles[mles$vl.info == "known",])
dev.off()

pdf("ode_based_with_duplicates_typical_vl_half_lives.pdf")
plot.all.individuals.half.lives(mles[mles$vl.info == "typical",])
dev.off()

pdf("ode_based_with_duplicates_typical_vl_half_lives_two_sampling_points.pdf")
