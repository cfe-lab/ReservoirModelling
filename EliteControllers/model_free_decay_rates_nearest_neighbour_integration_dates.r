...
# drawn using a nearest-neighbour method.
# The details of this analysis:
#  - "nearest neighbour" integration data
#  - special handling for P3's VL data (i.e. model starts from the 
#    blip rather than ART initiation)
...
integration.data <- prepare.nearest.neighbour.integration.data(
    subjects,
    vl.data
)
...
for (subject in subjects) {
    ...
    cairo_pdf(paste("model_free_decay_rate_nearest_neighbour_integration_dates_", subject, ".pdf", sep=""))
    model.free.plot(
