...
# drawn from Harrison's alternative dating method.
# The details of this analysis:
#  - "alternative trees" integration data
...
integration.data <- prepare.alternative.trees.integration.data(
    subjects,
    vl.data,
...
for (subject in subjects) {
    ...
    cairo_pdf(paste("model_free_decay_rate_alternative_trees_integration_dates_", subject, ".pdf", sep=""))
    model.free.plot(
