...
for (regime in regimes) {
    ...
    pdf(paste("lls_", subject, "_", regime, "_known_vl_no_special_handling_no_duplicates.pdf", sep=""))
    ll.plot(
...
for (regime in regimes) {
    ...
    pdf(paste("composition_", subject, "_", regime, "_known_vl_no_special_handling_no_duplicates.pdf", sep=""))
    composition.plot(
